...
CREATE TABLE IF NOT EXISTS `user_claims` (
  ...
  CONSTRAINT fk_user_claims1 FOREIGN KEY (user_id) REFERENCES users(id),
	CONSTRAINT fk_user_claims2 FOREIGN KEY (week_id) REFERENCES available_weeks(id)
);
...
INSERT INTO `available_weeks` (id, text) VALUES (1, '01/01/2019');
INSERT INTO `available_weeks` (id, text) VALUES (2, '01/07/2019');
INSERT INTO `available_weeks` (id, text) VALUES (3, '01/14/2019');
INSERT INTO `available_weeks` (id, text) VALUES (4, '01/21/2019');

CREATE TABLE IF NOT EXISTS `claim_type_available_weeks` (
	`id` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
	`claim_type_id` int(11) NOT NULL,
  `week_id` int(11) NOT NULL,
  `created_on` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_on` TIMESTAMP NOT NULL DEFAULT NOW() ON UPDATE NOW(),
  CONSTRAINT fk_claim_type_available_weeks1 FOREIGN KEY (claim_type_id) REFERENCES claim_types(id),
  CONSTRAINT fk_claim_type_available_weeks2 FOREIGN KEY (week_id) REFERENCES available_weeks(id)
);

INSERT INTO `claim_type_available_weeks` (claim_type_id, week_id) VALUES (1, 1);
INSERT INTO `claim_type_available_weeks` (claim_type_id, week_id) VALUES (1, 2);
INSERT INTO `claim_type_available_weeks` (claim_type_id, week_id) VALUES (1, 3);
INSERT INTO `claim_type_available_weeks` (claim_type_id, week_id) VALUES (1, 4);
